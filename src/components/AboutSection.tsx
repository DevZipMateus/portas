    ...
    <section id="about" ref={sectionRef} className="section-padding bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          <Badge variant="outline" className="mb-4 text-xs sm:text-sm animate-on-scroll">
            Sobre a Mportas
          </Badge>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 animate-on-scroll">
            Mais de 17 Anos Transformando Ambientes
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base animate-on-scroll">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-16">
          ...
          <div className="animate-on-scroll">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Nossa História e Missão</h3>
          ...
          {stats.map((stat, index) => (
            <Card key={index} className="text-center service-card animate-on-scroll border-none shadow-card">
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="font-medium text-foreground mb-1 text-sm sm:text-base">{stat.label}</div>
